...
<div class="container">
  ...
  <p>
    <a href="informasi_input.php">
      <input type="button" class="btn btn-primary" value="Tambah Informasi Kesehatan">
    </a>
  </p>
  <?php
  if ($sukses) {
    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <td><img src="../gambar/<?php echo informasi_foto($r1['id']) ?>" style="max-height:100px;max: width 100px;" />
          </td>
