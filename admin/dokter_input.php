...
if (isset($_POST['simpan'])) {
  ...
  if (empty($error)) {
    ...
    if ($id != "") {
      $sql1       = "update dokter set email = '$email', password = '$password', no_telp = '$no_telp', alamat = '$alamat', spesialis = '$spesialis', pengalaman = '$pengalaman', jenis_kelamin = '$jenis_kelamin', tanggal_masuk = '$tanggal_masuk', nama = '$nama',foto='$foto_name',isi='$isi',tgl_isi=now() where id = '$id'";
    } else {
...
<div class="container">
  ...
  <div class="mb-3">
    <a href="dokter.php" class="btn btn-primary">
      Kembali ke Halaman Dokter</a>
  </div>
  <?php
  if ($error) {
  ?>
  ...
  <form action="" method="post" enctype="multipart/form-data" class="row g-3 mt-2">
    ...
    <div class="col-md-6">
      ...
      <input type="email" class="form-control" name="email" value="<?php echo $email ?>" placeholder="Masukkan email">
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
      ...
      <input type="text" class="form-control" name="alamat" value="<?php echo $alamat ?>" placeholder="Masukkan alamat">
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
      ...
      <input type="text" class="form-control" name="spesialis" value="<?php echo $spesialis ?>"
        placeholder="Masukkan spesialis">
    </div>
    <div class="col-md-6">
      <label class="form-label">Pengalaman</label>
      <input type="text" class="form-control" name="pengalaman" value="<?php echo $pengalaman ?>"
    ...
    <div class="col-md-6">
      ...
      <input type="date" class="form-control" name="tanggal_masuk" value="<?php echo $tanggal_masuk ?>"
        placeholder="Masukkan no telepon">
    </div>
    <div class="col-md-12">
